  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      style: {
        ...
        background: selected ? `linear-gradient(135deg, ${color}22, ${color}08)` : "rgba(255,255,255,0.03)",
        padding: "16px 12px",
        textAlign: "center",
...
function PromptBox({ prompt, isVeo }) {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: isVeo ? "✅ VEO 3 PROMPT READY" : "✅ SCENE PROMPT READY"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
...
function CharactersTab({
  ...
  const filtered = filterCategory === "All" ? CHARACTERS : CHARACTERS.filter((c) => c.category === filterCategory);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { animation: "fadeInUp 0.4s ease" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: filtered.map((char, idx) => {
          const sel = (selectedChar == null ? void 0 : selectedChar.id) === char.id;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            SelectCard,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: VEHICLES.map((v, idx) => {
          const sel = (selectedVehicle == null ? void 0 : selectedVehicle.id) === v.id;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            SelectCard,
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { animation: "fadeInUp 0.4s ease" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: ANIMALS.map((a, idx) => {
          const sel = (selectedAnimal == null ? void 0 : selectedAnimal.id) === a.id;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            SelectCard,
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { animation: "fadeInUp 0.4s ease" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: BACKGROUNDS.map((bg, idx) => {
...
function SceneTab({
  ...
  const handleGenerateScene = async () => {
    ...
    setGenerating(true);
    setGeneratedPrompt("");
    const charName = selectedChar ? selectedChar.name : (selectedAnimal == null ? void 0 : selectedAnimal.name) ?? "";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { animation: "fadeInUp 0.4s ease" }, children: [
          ...
          children: RENDER_STYLES.map((rs) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "20px", marginBottom: "4px" }, children: rs.label.split(" ")[0] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: LIGHTING.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillBtn,
        {
          label: l,
          active: lighting === l,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: POSES.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillBtn,
        {
          label: p,
          active: pose === p,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "28px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: EXPRESSIONS.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillBtn,
        {
          label: e,
          active: expression === e,
    ...
    !canGenerate && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: "⚠️ Select a Hero or Animal Companion first"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        style: {
          ...
          background: canGenerate ? "linear-gradient(135deg, #00f5ff, #7b2ff7)" : "rgba(255,255,255,0.1)",
          color: canGenerate ? "#050510" : "#fff",
          transition: "all 0.3s",
          animation: canGenerate && !generating ? "pulse-glow 2s infinite" : "none",
          textTransform: "uppercase"
        },
        children: generating ? "⟳ Generating Scene..." : "⚡ Generate Scene Prompt"
      }
    ),
    generating && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: "Processing your 3D scene..."
      }
    ),
    generatedPrompt && /* @__PURE__ */ jsxRuntimeExports.jsx(PromptBox, { prompt: generatedPrompt })
  ] });
}
function Veo3Tab({
  selectedChar,
  ...
  const [videoDuration, setVideoDuration] = reactExports.useState("8s");
  const [videoRatio, setVideoRatio] = reactExports.useState("16:9 Landscape");
  const [videoQuality, setVideoQuality] = reactExports.useState("1080p FHD");
  const [cameraMove, setCameraMove] = reactExports.useState("orbit");
  const [motionStyle, setMotionStyle] = reactExports.useState("cinematic");
  const [soundFx, setSoundFx] = reactExports.useState("💥 Epic Score");
  const [veoScene, setVeoScene] = reactExports.useState("intro");
  const [generatingVideo, setGeneratingVideo] = reactExports.useState(false);
  const [videoPrompt, setVideoPrompt] = reactExports.useState("");
  const [videoProgress, setVideoProgress] = reactExports.useState(0);
  const [customVideoDesc, setCustomVideoDesc] = reactExports.useState("");
  const canGenerate = !!(selectedChar || selectedAnimal);
  const handleGenerateVideo = async () => {
    ...
    const motionPick2 = MOTION_STYLES.find((m) => m.id === motionStyle);
    const customNote = customVideoDesc ? ` Additional detail: ${customVideoDesc}.` : "";
    const veo3Prompt = `[Veo 3 Cinematic Video Prompt]

SUBJECT: ${charName}${vehicle}, 3D ${renderStyle} style
SCENE: ${scenePick == null ? void 0 : scenePick.template}
WORLD: ${selectedBg.name} environment
CAMERA: ${cameraPick == null ? void 0 : cameraPick.label.replace(/^\S+\s/, "")} shot
MOTION: ${motionPick2 == null ? void 0 : motionPick2.label.replace(/^\S+\s/, "")} style
...
FULL DESCRIPTION: Generate a ${videoDuration} ${motionPick2 == null ? void 0 : motionPick2.label.replace(/^\S+\s/, "").toLowerCase()} 3D animated video of ${charName}${vehicle} performing a ${scenePick == null ? void 0 : scenePick.template} in a cinematic ${selectedBg.name} environment. Use ${cameraPick == null ? void 0 : cameraPick.label.replace(/^\S+\s/, "").toLowerCase()} camera movement. Render in ${renderStyle} 3D style with ${lighting.replace(/^\S+\s/, "").toLowerCase()} lighting. Output at ${videoQuality}, ${videoRatio} aspect ratio.${customNote}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { animation: "fadeInUp 0.4s ease" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "8px", flexWrap: "wrap" }, children: VIDEO_DURATIONS.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillBtn,
        {
          label: d,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "8px", flexWrap: "wrap" }, children: VIDEO_RATIOS.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillBtn,
        {
          label: r,
          active: videoRatio === r,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "8px", flexWrap: "wrap" }, children: VIDEO_QUALITIES.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillBtn,
        {
          label: q,
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                style: {
                  ...
                  background: active ? "rgba(255,140,0,0.12)" : "rgba(255,255,255,0.03)",
                  padding: "10px",
                  cursor: "pointer",
                  textAlign: "center",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "18px", marginBottom: "4px" }, children: cm.label.split(" ")[0] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                style: {
                  ...
                  background: active ? `${ms.color}18` : "rgba(255,255,255,0.03)",
                  padding: "10px",
                  cursor: "pointer",
                  textAlign: "center",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "18px", marginBottom: "4px" }, children: ms.label.split(" ")[0] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "8px", flexWrap: "wrap" }, children: SOUND_FX.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        PillBtn,
        {
          label: s,
          active: soundFx === s,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "20px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: VEO3_SCENES.map((scene) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "24px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: "CUSTOM DETAILS (OPTIONAL)"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
    ...
    generatingVideo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "veo3.loading_state", style: { marginBottom: "16px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: "RENDERING VIDEO..."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: "10px", color: "#ff8c00" }, children: [
              videoProgress,
              "%"
            ] })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        style: {
          ...
          background: canGenerate ? "linear-gradient(135deg, #ff5000, #ff9900, #ffdd00)" : "rgba(255,255,255,0.1)",
          color: canGenerate ? "#050510" : "#fff",
          transition: "all 0.3s",
          textTransform: "uppercase"
        },
        children: generatingVideo ? `⟳ Generating... ${videoProgress}%` : "🎥 Generate Veo 3 Prompt"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          (motionPick == null ? void 0 : motionPick.label) ?? "Cinematic",
          " ·",
          " ",
          videoQuality
        ]
    ...
    videoPrompt && /* @__PURE__ */ jsxRuntimeExports.jsx(PromptBox, { prompt: videoPrompt, isVeo: true })
  ] });
}
...
function App() {
  const [activeTab, setActiveTab] = reactExports.useState("characters");
  const [selectedChar, setSelectedChar] = reactExports.useState(null);
  const [selectedVehicle, setSelectedVehicle] = reactExports.useState(null);
  const [selectedBg, setSelectedBg] = reactExports.useState(BACKGROUNDS[0]);
  const [selectedAnimal, setSelectedAnimal] = reactExports.useState(null);
  const [renderStyle, setRenderStyle] = reactExports.useState("cartoon");
  const [lighting, setLighting] = reactExports.useState("🌟 Studio");
  const [pose, setPose] = reactExports.useState("🏃 Running");
  const [expression, setExpression] = reactExports.useState("😎 Epic");
      ...
      ` }),
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        style: {
                          ...
                          background: active ? isVeo ? "linear-gradient(135deg,#ff5000,#ff9900)" : "linear-gradient(135deg,#00f5ff,#7b2ff7)" : isVeo ? "rgba(255,140,0,.08)" : "rgba(0,245,255,.06)",
                          border: active ? "none" : isVeo ? "1px solid rgba(255,140,0,.25)" : "1px solid rgba(0,245,255,.15)",
                          transition: "all 0.2s"
                        },
                        children: [
                          t.icon,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "main",
          {
            ...
            children: [
              activeTab === "characters" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                CharactersTab,
                {
                  selectedChar,
                  setSelectedChar,
              ...
              activeTab === "vehicles" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                VehiclesTab,
                {
                  selectedVehicle,
                  setSelectedVehicle
              ...
              activeTab === "animals" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                AnimalsTab,
                {
                  selectedAnimal,
                  setSelectedAnimal
              ...
              activeTab === "backgrounds" && /* @__PURE__ */ jsxRuntimeExports.jsx(WorldsTab, { selectedBg, setSelectedBg }),
              activeTab === "scene" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                SceneTab,
                {
                  selectedChar,
                  selectedAnimal,
